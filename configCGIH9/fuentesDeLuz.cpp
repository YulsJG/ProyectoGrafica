...
// Positions of the point lights arreglo de luces 4 luces puntuales 
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].specular"), 0.0f, 0.0f, 1.5f); 
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 0.0f, 1.0f, 0.0f); //verde
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[2].specular"), 1.5f, 0.0f, 1.5f);//rosa
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[3].specular"), 1.0f, 0.0f, 0.0f);//naranja
		...
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "transparency"), 1);//por defauld es 0 con 1 activa la transparencia
...
//ejercicio usar las tres puntuales cambiandolas de posicion en el piso y que cada luz tenga un color diferente